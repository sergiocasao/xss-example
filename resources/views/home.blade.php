            ...
            <div style="padding: 20px; background-color: white; border-radius: 5px;">
                <div style="display: flex;">
                    <div style="margin-right: 10px;">
                        <img class="media-object" src="http://lorempixel.com/48/48?me" alt="..." style="border-radius: 50%; margin-bottom: 10px;">
                    </div>
                    <div>
                ...
                @foreach ($statuses as $status)
                    ...
                    <li class="media" style="padding: 20px;">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="http://lorempixel.com/48/48?me" alt="..." style="border-radius: 50%;">
                            </a>
                        </div>
                        <div class="media-body">
                            ...
                            @foreach ($status->comments as $comment)
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="media-object" src="http://lorempixel.com/48/48?id={{ $comment->user->name }}" alt="..." style="border-radius: 50%;">
                                        </a>
                                    </div>
                                    <div class="media-body">
